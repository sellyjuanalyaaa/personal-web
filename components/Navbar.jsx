...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="glass border-b border-white/50 bg-white/75 px-4 py-3 dark:border-slate-800/70 dark:bg-slate-950/75 sm:px-6 lg:px-8">
        <div className="relative mx-auto flex w-full max-w-7xl items-center justify-center">
          <PillNav
            logo="/images/sellyjuan-logo.svg"
            logoAlt="Selly Juan Logo"
            items={navItems}
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="absolute right-0 top-1/2 inline-flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-sm hover:-translate-y-[55%] hover:border-slate-300 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200 dark:hover:border-slate-700 dark:hover:bg-slate-900"
